...
function uninstallExtraWatchMain()  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
{
    ...
    try {
		$query = "SHOW TABLES LIKE '%#__extrawatch_config%'";  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
    ...
    if (strtolower(@$keepData) == 'on') {  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        ...
        try {
         ...
         $extraWatch->downloads->deleteEverythingFromHtaccess();  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
?>
<iframe src="http://www.extrawatch.com/track/extrawatch/2.3/uninstall/?time=<?php echo time();?>" width="1px" height="1px" frameborder="0">  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
</iframe>
