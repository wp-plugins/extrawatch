...
class ExtraWatchTrendHTML
{
    ...
    function renderDayTrends($group, $name, $date)
    {
        ...
        $output .= "<tr>";
        $progressBarIcon = $this->extraWatch->config->getLiveSiteWithSuffix() . "components/com_extrawatch/icons/progress_bar_vertical.gif";
    ...
    function renderWeekTrends($group, $name, $date)
    {
        ...
        $output .= "<table>";
        $output .= "<tr>";
        $progressBarIcon = $this->extraWatch->config->getLiveSiteWithSuffix() . "components/com_extrawatch/icons/progress_bar_vertical_wide.gif";
