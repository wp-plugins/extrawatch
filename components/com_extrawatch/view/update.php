...
1. <b><a href="<?php echo $this->extraWatch->env->getRootSite();?>administrator/index.php?option=com_installer&view=update">Open update manger</a></b> <br/><br/>

2. Click Find Updates<br/><br/>

3. Go back to ExtraWatch -> Update and <b><a href="<?php echo $this->extraWatch->env->getRootSite();?>administrator/index.php?option=com_installer&view=update">Open
