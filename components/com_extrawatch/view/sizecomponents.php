...
<table align="center" border='0' style='border: 1px solid #dddddd; padding: 2px;' border-collapse="collapse">
    ...
    $this->extraWatch->sizes->renderFileList(DB_KEY_SIZE_COM, $scanDirectoryMain, $scanDirectoryAdmin, $realDirectoryMain, $realDirectoryAdmin, "components");
...
<script type="text/javascript">
    ...
    echo "document.getElementById(\"uprefreshComponents\").innerHTML = \"<br/><a href='javascript:refreshComponentsAll(1, " . $this->extraWatch->sizes->renderPageItems . ")'><img src='" . $this->extraWatch->config->getLiveSiteWithSuffix() . "components/com_extrawatch/icons/refresh_all.png' border='0' title='" . _EW_SIZECOMPONENTS_REFRESH_ALL . "'/></a>\"";
    ?>
    ...
    function refreshComponentsTotal() {
        $.ajax({
            ...
            data:"prev=" + total_components + "&mod=<?php echo DB_KEY_SIZE_COM;
    ...
    function refreshSize_components(index) {
        ...
        $.ajax({
            ...
            data:"dir=" + dirs_components[index] + "&mod=" + <?php echo DB_KEY_SIZE_COM; ?>,
            success:function (resp) {
