...
<a href='http://www.extrawatch.com/support/faq/view-knowledgebase/1-questions-and-answers' target='_blank'><?php echo _EW_MENU_FAQ;?> <img  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
    src='<?php echo($extraWatch->config->getLiveSiteWithSuffix());?>components/com_extrawatch/img/icons/external.png'
    border='0'/></a>   	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
...
<a href='https://www.e-junkie.com/ecom/gb.php?i=1013699&c=single&cl=189955&on0=Promotion&os0=Promotion40';' target='_blank' title='<?php echo _EW_DOWNLOAD_PRO;?>'><?php echo _EW_DOWNLOAD_PRO;?></a> <img  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
    src='<?php echo($extraWatch->config->getLiveSiteWithSuffix());?>components/com_extrawatch/img/icons/external.png'
    border='0'/></a>  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
