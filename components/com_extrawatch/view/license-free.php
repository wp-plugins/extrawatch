...
<tr>
    <td>
        ...
        <tr><td valign='top' colspan='2'>
            ...
            <iframe src='http://www.codegravity.com/demo/extrawatch/2.2/".strtolower($extraWatch->env->getEnvironmentName())."/' width='1100' height='768'>
            </iframe>
            <br/><br/>
