...
<table width='100%' cellpadding='4' class="table table-striped tablesorter">
    <thead>
    <tr>
...
<!--            <?php /*echo $extraWatchGoalHTML->renderCell($style, @$row->get_var);*/?>  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
            ...
            <td class='ewCentered' style='<?php echo $style;?>'><?php echo @$extraWatchGoalHTML->renderActionButtons($row->id);?></td>
