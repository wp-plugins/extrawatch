...
class extrawatch extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->version = '2.1.778';
        $this->displayName = 'ExtraWatch FREE';
		$this->tab = 'analytics_stats'; 
		
		
		
		$this->module_key='aefa1ec20ddd7cdc116f9ea27c215595';
