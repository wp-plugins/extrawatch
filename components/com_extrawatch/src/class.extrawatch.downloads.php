...
class ExtraWatchDownloads  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
{
    ...
    function addFilePath($filepathnamename, $allowedReferrer = "") {
        ...
        $textBeforeInHtAccess = "\nRewriteEngine on"."\n"."RewriteRule ^(".$pathsDividedBySeparator.")$ ".$path.$this->env->renderAjaxLink('ajax','download')."&env=$env&params=".urlencode("&rand=")."&file="."$1 [R,L]";  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  

        $root_file = $this->env->getRootPath().DS.".htaccess";  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        $existingContentOfHtAccess = @file_get_contents($root_file);  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        ...
        $newContentToWriteToHtAccess .= "RewriteRule ^(".$pathsDividedBySeparator.")$ ".$path.$this->env->renderAjaxLink('ajax','download')."&env=$env&params=".urlencode("&rand=")."&file="."$1 [R,L]";  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
    ...
    function getDownloadLog() {  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        $query = sprintf("  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        SELECT ddate, downloadLog.ip AS ip, referrerId, downloadLog.timestamp, dname, allowedReferrer, referrerURL, #__extrawatch_user_log.userId AS userId  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        FROM (
            SELECT ddate, #__extrawatch_dm_counter.ip AS ip, referrerId, timestamp, dname, allowedReferrer, #__extrawatch_dm_referrer.referrer AS referrerURL  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
            ...
            ORDER BY #__extrawatch_dm_counter.id DESC  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
            LIMIT 100  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        ) AS downloadLog  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
        LEFT JOIN #__extrawatch_user_log ON #__extrawatch_user_log.ip = downloadLog.ip");  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
