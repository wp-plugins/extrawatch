...
class ExtraWatchStatHTML
{
    ...
    function renderExpand($element, $total = FALSE)
    {
        ...
        $output = "<a name='$element'></a><a href=\"javascript:extraWatchExpand('$element" . $elementSuffix . "')\" id='$element" . $elementSuffix . "'><img src='" . $this->extraWatch->config->getLiveSiteWithSuffix() . "components/com_extrawatch/img/icons/$operation.gif' border='0' alt='$operation'/>$operationTranslated&nbsp;$elementTranslated</a>";
